			...
			<div class="p-6">
				...
				<div class="flex gap-4">
					<a href={selectedProject.github} target="_blank" rel="noopener"
						class="flex items-center gap-2 px-5 py-2.5 rounded-lg font-mono text-sm border border-cyan-500/40 hover:border-neon-blue hover:text-neon-blue transition-all">
